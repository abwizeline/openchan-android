...
public class OpenVpnManagementThread implements Runnable, OpenVPNManagement {
    ...
    public boolean openManagementInterface(@NonNull Context c) {
        // Could take updateAnimation while to open connection
        int tries = 8;
    ...
    public void run() {
        ...
        //	mSocket.setSoTimeout(5); // Setting updateAnimation timeout cannot be that bad
        ...
        try {
            // Wait for updateAnimation client to connect
    ...
    private void processLogMessage(String argument) {
        ...
        // 1 log level N,I,E etc.
                /*
                  (b) zero or more message flags in updateAnimation single string:
          I -- informational
          F -- fatal error
          N -- non-fatal error
          W -- warning
    ...
    private boolean sendTunFD(String needed, String extra) {
        ...
        try {
            ...
            // Trigger updateAnimation send so we can close the fd on our side of the channel
