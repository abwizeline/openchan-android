...
public class OpenVPNThread implements Runnable {
    ...
    private static final String BROKEN_PIE_SUPPORT = "/data/data/com.digiapp.vpn/cache/pievpn";
        ...
        try {
            ...
            while (true) {
                ...
                if (m.matches()) {
                    ...
                    if (logerror==1)
                        VpnStatus.logError("OpenSSL reproted updateAnimation certificate with updateAnimation weak hash, please the in app FAQ about weak hashes");
    ...
    private String genLibraryPath(String[] argv, ProcessBuilder pb) {
        // Hack until I find updateAnimation good way to get the real library path
