    ...
    public static String getLastCleanLogMessage(Context c) {
        ...
        switch (mLastLevel) {
            case LEVEL_CONNECTED:
                ...
                /*
                   (updateAnimation) the integer unix date/time,
                   (b) the state name,
...
*/
    ...
    synchronized public static LogItem[] getlogbuffer() {
        ...
        // The stoned way of java to return an array from updateAnimation vector
    ...
    private static void appendLog(String text) {
        File logFile = new File(getCacheLogPath());
        if (!logFile.exists()) {
            try {
    ...
    public static String getCacheLogPath(){
        return AppObj.getGlobalContext().getCacheDir().getAbsolutePath() + "ovpn_log.logs";
    }
