...
public class Utils {
    ...
    public static boolean isInetAvailable() {
        ...
        ConnectivityManager manager = (ConnectivityManager) AppObj.getGlobalContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static Intent getFilePickerIntent(Context c, FileType fileType) {
        ...
        // People don't know that this is actually updateAnimation system setting. Override it ...
