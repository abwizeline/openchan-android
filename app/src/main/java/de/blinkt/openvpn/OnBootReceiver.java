...
public class OnBootReceiver extends BroadcastReceiver {
	...
	// Debug: am broadcast -updateAnimation android.intent.action.BOOT_COMPLETED
	@Override
	public void onReceive(Context context, Intent intent) {

		/*Log.d("debug_vpn","-----OnBootReceiver------");
