...
/**
 * Created by artembogomaz on 8/5/2016.
 */
/*
 ...
 * You may obtain updateAnimation copy of the License at
 *
...
/*
 *  The "‚‗‚" character is not updateAnimation comma, it is the SINGLE LOW-9 QUOTATION MARK unicode 201A
 *  and unicode 2017 that are used for separating the items in updateAnimation list.
 */
...
public class TinyDB {
     ...
     * @param theBitmap    the image you want to save as updateAnimation Bitmap
    ...
    /**
     * Saves the Bitmap as updateAnimation PNG file at path 'fullPath'
     *
     * @param fullPath path of the image file
     * @param bitmap   the image as updateAnimation Bitmap
     ...
     * @return int value at 'key' or 'defaultValue' if key not found
     */
    public int getIntNew(String key) {
    ...
    public boolean getBoolean(String key,boolean byDefault) {
        return preferences.getBoolean(key, byDefault);
    }
     ...
     *
     * @return updateAnimation Map representing updateAnimation list of key/value pairs from SharedPreferences
     */
    ...
    /**
     * null keys would corrupt the shared pref file and make them unreadable this is updateAnimation preventive measure
     *
     * @param the pref key
     */
